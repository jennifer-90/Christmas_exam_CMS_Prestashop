                ...
                <form class="ynp-form ynp-form-popup" action="{$YBC_NEWSLETTER_ACTION|escape:'html':'UTF-8'}" method="post">
                    <div class="ynp-inner">
                        ...
                        <div class="ynp-inner-wrapper">
                            ...
                            {if isset($YBC_NEWSLETTER_rss_url) && $YBC_NEWSLETTER_rss_url != '' || isset($YBC_NEWSLETTER_li_url) && $YBC_NEWSLETTER_li_url != '' || isset($YBC_NEWSLETTER_youtb_url) && $YBC_NEWSLETTER_youtb_url != '' || isset($YBC_NEWSLETTER_in_url) && $YBC_NEWSLETTER_in_url != '' || isset($YBC_NEWSLETTER_vimeo_url) && $YBC_NEWSLETTER_vimeo_url != '' || isset($YBC_NEWSLETTER_pin_url) && $YBC_NEWSLETTER_pin_url != '' || isset($YBC_NEWSLETTER_gg_url) && $YBC_NEWSLETTER_gg_url != '' || isset($YBC_NEWSLETTER_fb_url) && $YBC_NEWSLETTER_fb_url != '' || isset($YBC_NEWSLETTER_tw_url) && $YBC_NEWSLETTER_tw_url != ''}
